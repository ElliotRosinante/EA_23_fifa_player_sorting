...
# with open("playerDetailedStats_4.csv",mode = "w",newline = '',encoding='utf-8') as csv_file:
...
with open("playerShallowstats.csv",encoding="utf-8") as csv_file:
    ...
    for i,row in enumerate(csv_reader):
        if counter>=488:
            ...
            with open("playerDetailedStats_4.csv",mode = "a", newline = '',encoding='utf-8') as file:
